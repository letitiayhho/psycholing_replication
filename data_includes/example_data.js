var shuffleSequence;
if (math.random < 0.5) {
    shuffleSequence = seq("setcounter", "intro", "practice", "presep", sepWith("sep", startsWith("test_a")), "exit");
} else {
    shuffleSequence = seq("setcounter", "intro", "practice", "presep", sepWith("sep", startsWith("test_b")), "exit");
}
...
var items = [
   ...
   [["test_a",5], "DashedSentence", {s: ["The woman determined that the estimate had been inflated by the accountant."]},
               "Question",       {q: "The woman thought the accountants were:", as: ["honest", "dishonest"]}],
   [["test_b",5], "DashedSentence", {s: ["The woman determined the estimate had been inflated by the accountant."]},
               "Question",       {q: "The woman thought the accountants were:", as: ["honest", "dishonest"]}],

   [["test_a",6], "DashedSentence", {s: ["The men discovered the island had been invaded by the enemy."]},
               "Question",       {q: "Who invaded the island?:", as: ["the men", "the enemy"]}],
   [["test_b",6], "DashedSentence", {s: ["The men discovered that the island had been invaded by the enemy."]},
               "Question",       {q: "Who invaded the island?:", as: ["the men", "the enemy"]}]
]
